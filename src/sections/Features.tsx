  ...
  return (
    <Element name="features">
        <section className="container pt-36 max-md:pt-32">
            <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-5">
                    ...
                    <div key={id} className='relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320'>
                        <div className="w-full flex justify-start items-start">
                            <div className="-ml-3 mb-12 flex flex-col items-center justify-center">
                                ...
                                <img src={icon as string} alt={title} className='size-28 object-contain'/>
                            </div>
                        </div>
