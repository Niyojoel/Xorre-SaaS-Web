    ...
    <section>
        <Element name="faq" className="relative">
            <div className="container relative z-2 pt-32 pb-20">
                ...
                {/* <div className={clsx('w-0.5 h-full absolute left-[calc(50%-1px)] top-2 -z-1', themeStyle("bg-s2", "bg-s2 bg-opacity-20"))}/> */}
            </div>
            <div className={clsx("faq-glow_before relative z-2 border-2 bg-[var(--s1)]", themeStyle("border-s2 border-opacity-100", "border-p4 border-opacity-80"))}>
                <div className="container flex gap-10 max-lg:block">
                    <div className={clsx("rounded-half absolute -top-10 max-md:-top-7 left-[calc(50%-40px)] z-4 flex size-20 max-md:size-16 items-center justify-center border-2",themeStyle("bg-s2 border-s2", "bg-[var(--p4)] border-[var(--p4)]"))}>
