  ...
  return (
    <section>
      <Element name="download" className={clsx("g7 relative", themeStyle("pb-28 max-lg:pb-24 max-md:pt-0 max-md:pb-0", "pb-0"))}>
        <div className={clsx("h-[112vh] max-xl:h-[100vh] max-sm:h-[100vh]", themeStyle("", ""))}>
          <div className="container flex items-center h-[100%] max-lg:md:pt-28">
            <div className="mr-6 flex-540 max-xl:flex-200 max-lg:flex-256 max-md:flex-100">
              <div className="relative flex items-center mb-10">
                {theme === "dark" ? (
                <img src="/images/xorre.svg" alt="logo" width={160} height={55}/>
                ) : (
              ...
              <ul className="flex flex-wrap items-center gap-6 max-md:gap-4">
                {links.map(({id, url, icon})=> (
                  <li key={id} className='download_tech-link download_tech-link_last-before download_tech-link_last-after'>
                    <a href={url} download="favicon.ico" className='size-22 max-lg:size-20 max-md:size-16 max-sm:size-12 download_tech-icon_before relative flex items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500'>
            ...
            <div className="bg_container h-[100%] max-md:hidden">
              <div className="absolute mb-10 left-[45%] max-xl:left-[55%] max-lg:left-[50%] top-[6%]">
                <div className="download_preview-before download_preview-after rounded-40 relative w-[100%]  max-xl:w-[800px] border-2 border-s5 p-6">
                  <div className="relative rounded-3xl bg-s1 px-4 pb-6 pt-14">
                    ...
                    <img src="/images/screen.jpg" alt="screen" width={755} height={655} className='rounded-xl pointer-events-none'/>
        ...
        <div className={clsx("overflow-auto z-20 max-md:py-12 relative scroll-hide", themeStyle("bg-none pt-10 max-xl:pt-22 max-md:pt-0 max-md:pb-22", "bg-s2 py-20 max-xl:mt-24 max-md:mt-0"))}>
